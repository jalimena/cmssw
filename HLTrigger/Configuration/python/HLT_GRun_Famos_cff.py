# /dev/CMSSW_7_1_1/GRun/V8 (CMSSW_7_1_0_pre6)
...
HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_7_1_1/GRun/V8')
)
...
hltParticleFlowBlock = cms.EDProducer( "PFBlockProducer",
    ...
    PFClustersECAL = cms.InputTag( "hltParticleFlowClusterECALUnseeded" ),
    verbose = cms.untracked.bool( False ),
    PFClustersPS = cms.InputTag( "hltParticleFlowClusterPSUnseeded" ),
...
hltFastPixelBLifetimeL3TagInfosHbb = cms.EDProducer( "TrackIPProducer",
...
hltBLifetimeL3FilterHbbCSV = cms.EDFilter( "HLTCaloJetTag",
    saveTags = cms.bool( True ),
    MinJets = cms.int32( 1 ),
...
HLTFastRecopixelvertexingSequence = cms.Sequence( hltFastPrimaryVertex + hltPixelLayerTriplets + hltFastPVPixelTracks + hltFastPVJetTracksAssociator + hltFastPVJetVertexChecker + hltFastPVPixelTracksRecover + hltFastPVPixelTracksMerger + hltFastPVPixelVertices )
HLTFastPrimaryVertexSequence = cms.Sequence( hltSelector4JetsL1FastJet + hltSelectorJets20L1FastJet + HLTDoLocalPixelSequence + HLTFastRecopixelvertexingSequence )
HLTBtagCSVSequenceL3Hbb = cms.Sequence( HLTDoLocalPixelSequence + HLTDoLocalStripSequence + hltPixelLayerPairs + hltFastPixelBLifetimeRegionalPixelSeedGeneratorHbb + hltFastPixelBLifetimeRegionalCkfTrackCandidatesHbb + hltFastPixelBLifetimeRegionalCtfWithMaterialTracksHbb + hltFastPixelBLifetimeL3AssociatorHbb + hltFastPixelBLifetimeL3TagInfosHbb + hltL3SecondaryVertexTagInfos + hltL3CombinedSecondaryVertexBJetTags )
...
HLT_Mu40_v15 = cms.Path( HLTBeginSequence + hltL1sMu16 + hltPreMu40 + hltL1fL1sMu16L1Filtered0 + HLTL2muonrecoSequence + hltL2fL1sMu16L1f0L2Filtered16Q + HLTL3muonrecoSequence + hltL3fL1sMu16L1f0L2f16QL3Filtered40Q + cms.SequencePlaceholder( "HLTEndSequence" ) )
HLT_IsoMu24_IterTrk02_v1 = cms.Path( HLTBeginSequence + hltL1sMu16 + hltPreIsoMu24IterTrk02 + hltL1fL1sMu16L1Filtered0 + HLTL2muonrecoSequence + hltL2fL1sMu16L1f0L2Filtered16Q + HLTL3muonrecoSequence + hltL3fL1sMu16L1f0L2f16QL3Filtered24Q + HLTL3muoncaloisorecoSequenceNoBools + HLTTrackReconstructionForIsoL3MuonRegIter02 + hltL3crIsoL1sMu16L1f0L2f16QL3f24QL3crIsoRhoFiltered0p15IterTrk02 + cms.SequencePlaceholder( "HLTEndSequence" ) )
...
HLT_Ele27_WP80_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleEG20ORL1SingleEG22 + hltPreEle27WP80 + HLTEle27WP80Sequence + cms.SequencePlaceholder( "HLTEndSequence" ) )
...
HLT_Ele17_Ele8_Mass50_v1 = cms.Path( HLTBeginSequence + hltL1sL1DoubleEG137 + hltPreEle17Ele8Mass50 + HLTEle17Ele8Mass50Sequence + cms.SequencePlaceholder( "HLTEndSequence" ) )
...
HLT_Photon26_R9Id85_Photon18_CaloId10_Iso50_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleEG22 + hltPrePhoton26R9Id85Photon18CaloId10Iso50 + HLTPhoton26R9Id85Photon18CaloId10Iso50Sequence + cms.SequencePlaceholder( "HLTEndSequence" ) )
HLT_PFMET150_NoiseCleaned_v1 = cms.Path( HLTBeginSequence + hltL1sL1ETM36ORETM40 + hltPrePFMET150NoiseCleaned + HLTRecoMETSequence + hltMET90 + HLTHBHENoiseCleanerSequence + hltMetClean + hltMETClean80 + HLTRecoJetSequenceAK4L1FastJetCorrected + hltMetCleanUsingJetID + hltMETCleanUsingJetID80 + HLTPFL1FastL2L3ReconstructionSequence + hltPFMETProducer + hltPFMET150Filter + cms.SequencePlaceholder( "HLTEndSequence" ) )
...
HLTSchedule = cms.Schedule( *(HLTriggerFirstPath, HLT_Mu17_NoFilters_v1, HLT_Mu40_v15, HLT_IsoMu24_IterTrk02_v1, HLT_DoubleMu4NoFilters_Jpsi_Displaced_v1, HLT_Mu17_Mu8_v23, HLT_Mu17_TkMu8_v15, HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_v1, HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_v1, HLT_Ele27_WP80_v1, HLT_Ele27_WP80_Gsf_v1, HLT_Ele17_Ele8_Mass50_v1, HLT_Ele17_Ele8_Gsf_v1, HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_v1, HLT_Photon20_CaloIdVL_IsoL_v1, HLT_Photon26_R9Id85_Photon18_CaloId10_Iso50_v1, HLT_PFMET150_NoiseCleaned_v1, HLT_PFMET180_NoiseCleaned_v1, HLT_MonoCentralPFNoPUJet100_PFMET100_NHF0p95_NCH1_v1, HLT_DiCentralPFNoPUJet60_30_PFMET100_dphi0p5_v1, HLT_DiCentralPFNoPUJet60_PFMET80_dphi0p3_v1, HLT_DiCentralPFNoPUJet30_PFMET80_BTagCSV07_v1, HLT_DiCentralPFNoPUJet30_PFMET80_v1, HLT_PFNoPUHT400_DiCentralPFNoPUJet40_PFMET80_v1, HLT_PFchMET90_NoiseCleaned_v1, HLTriggerFinalPath ))
