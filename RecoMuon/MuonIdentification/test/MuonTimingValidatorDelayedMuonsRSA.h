#ifndef RecoMuon_MuonIdentification_MuonTimingValidatorDelayedMuonsRSA_H
#define RecoMuon_MuonIdentification_MuonTimingValidatorDelayedMuonsRSA_H
...
class MuonTimingValidatorDelayedMuonsRSA : public edm::EDAnalyzer {
public:
  explicit MuonTimingValidatorDelayedMuonsRSA(const edm::ParameterSet&);
  ~MuonTimingValidatorDelayedMuonsRSA();
