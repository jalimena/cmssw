...
// Class:      CSCTimingExtractorDelayedMuons
// 
/**\class CSCTimingExtractorDelayedMuons CSCTimingExtractorDelayedMuons.cc RecoMuon/MuonIdentification/src/CSCTimingExtractorDelayedMuons.cc
 *
...
// $Id: CSCTimingExtractorDelayedMuons.cc,v 1.10 2011/04/16 20:30:57 ptraczyk Exp $
//
//
...
//
//CSCTimingExtractorDelayedMuons::CSCTimingExtractorDelayedMuons(const edm::ParameterSet& iConfig)
CSCTimingExtractorDelayedMuons::CSCTimingExtractorDelayedMuons(const edm::ParameterSet& iConfig,edm::ConsumesCollector& iC)
  :
...
CSCTimingExtractorDelayedMuons::~CSCTimingExtractorDelayedMuons()
{
...
void
CSCTimingExtractorDelayedMuons::fillTiming(TimeMeasurementSequence &tmSequence, reco::TrackRef muonTrack, const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
//DEFINE_FWK_MODULE(CSCTimingExtractorDelayedMuons);
