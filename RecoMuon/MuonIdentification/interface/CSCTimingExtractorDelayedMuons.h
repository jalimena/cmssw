#ifndef MuonIdentification_CSCTimingExtractorDelayedMuons_H
#define MuonIdentification_CSCTimingExtractorDelayedMuons_H
...
// $Id: CSCTimingExtractorDelayedMuons.h,v 1.5 2011/02/24 15:41:53 farrell3 Exp $
//
//
...
public:
  ...
  /// Constructor
  CSCTimingExtractorDelayedMuons(const edm::ParameterSet&,edm::ConsumesCollector& iC);
  
  /// Destructor
  ~CSCTimingExtractorDelayedMuons();
