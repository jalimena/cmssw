...
// 
/**\class MuonTimingProducerDelayedMuons MuonTimingProducerDelayedMuons.cc RecoMuon/MuonIdentification/src/MuonTimingProducerDelayedMuons.cc
...
// $Id: MuonTimingProducerDelayedMuons.cc,v 1.6 2010/04/15 12:34:30 ptraczyk Exp $
//
//
...
//
MuonTimingProducerDelayedMuons::MuonTimingProducerDelayedMuons(const edm::ParameterSet& iConfig)
{
   ...
   theTimingFiller_ = new MuonTimingFillerDelayedMuons(fillerParameters,consumesCollector());
}


MuonTimingProducerDelayedMuons::~MuonTimingProducerDelayedMuons()
{
...
void 
MuonTimingProducerDelayedMuons::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
MuonTimingProducerDelayedMuons::endJob() {
}

// ------------ method called to produce the data  ------------
void
MuonTimingProducerDelayedMuons::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
